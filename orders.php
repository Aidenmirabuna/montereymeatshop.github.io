	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Branch Address</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Branch Address" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Branch Contact</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Branch Number" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Branch Address</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="branchaddress" name="branchaddress" placeholder="Branch Address" autocomplete="off" value="<?php echo $data[2] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Branch Contact</label>
			  ...
			  <div class="form-group editButtonFooter">
				...
				<a href="http://localhost/pukinginamo/Actual/stock/orders.php?o=manord"<button type="submit" id="manord" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-remove"></i> Cancel</button></a>
			    </div>
			  </div>
			</form>
